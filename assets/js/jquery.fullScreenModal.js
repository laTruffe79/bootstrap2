 ...
 * Windows 8 style login page or something else that treplace your old 
 * modals pages
 */

(function ($)
{
    $.fn.fullScreenModal = function (options)
    {
        // default settings
        var settings = $.extend({
            ...
            offsetMarginTop: 0,
            closeTag: '<a href="javascript:void(0)">Close</a>', // default Close anchor html format
        ...
        return this.each(function ()
        {
            ...
            thisO.on("click touchstart", function () {
                ...
                fswClose = fsw.children('div.closeTrigger');
