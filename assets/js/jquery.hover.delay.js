/* 
 * Hover delay
 * Ajoute un délai de déclenchement de l'event hover
 * l'ajout du délai est détecté en donnent un 3eme argument de temps de déclenchement
 *  $("#test").hover(function(){...},function(){...}, 200)
 */
